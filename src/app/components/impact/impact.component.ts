...
export class ImpactComponent implements AfterViewInit, OnDestroy {
  ...
  scenes: ImpactScene[] = [
    ...
    },
    {
      ...
      description: 'Carreteras, puentes y viviendas pueden quedar expuestos a daños severos. Las lluvias intensas generan deslizamientos y erosión que comprometen la conectividad del territorio.',
      image: 'assets/images/road_extreme.png',
      imageAlt: 'Carretera bajo condiciones extremas de lluvia',
      accentColor: '#c45c00',
      textColor: '#f0f4f8',
    },
    {
      ...
      number: '03',
      title: 'ECONOMÍA',
      description: 'Cuando el territorio se detiene, la economía también siente el impacto. Los sectores de pesca, agricultura y turismo son especialmente vulnerables a las anomalías climáticas.',
